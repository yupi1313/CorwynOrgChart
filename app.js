            ...
            children: [
                {
                    ...
                    title: "CTO",
                    children: [
                        { id: "6a1", name: "Development Team", title: "Team", isTeam: true, children: [] },
                        { id: "6a2", name: "QA Team", title: "Team", isTeam: true, children: [] },
                        { id: "6a3", name: "Infrastructure Team", title: "Team", isTeam: true, children: [] },
                        { id: "6a4", name: "Product Team", title: "Team", isTeam: true, children: [] },
                        { id: "6a5", name: "Product Design Team", title: "Team", isTeam: true, children: [] }
                    ]
                },
                { id: "6b", name: "Andrea", title: "Product", children: [] },
                {
                    id: "6c",
                    name: "Ivan Kornyuchenko",
                    title: "Marketing Manager",
                    children: [
                        { id: "6c1", name: "Marketing Team", title: "Team", isTeam: true, children: [] }
                    ]
                },
                {
                    id: "6d",
                    ...
                    title: "",
                    children: [
                        { id: "6d1", name: "Sales Team", title: "Team", isTeam: true, children: [] },
                        {
                            id: "6d2",
                            name: "New Employee",
                            title: "Sports Analyst Team Lead",
                            children: [
                                { id: "6d2a", name: "Tracking Analyst Team", title: "Team", isTeam: true, children: [] }
                            ]
                        },
                        {
                            id: "6d3",
                            name: "New Employee",
                            title: "Risk Analyst Team Lead",
                            children: [
                                { id: "6d3a", name: "Risk Team", title: "Team", isTeam: true, children: [] }
                            ]
                        },
                        {
                            id: "6d4",
                            ...
                            children: [
                                { id: "6d4a", name: "Trading Team", title: "Team", isTeam: true, children: [] }
                            ]
                        }
                    ]
                },
                { id: "6e", name: "Trading Ops", title: "", children: [] },
                { id: "6f", name: "Customer Success Team", title: "", children: [] }
            ]
        }
    ]
};
